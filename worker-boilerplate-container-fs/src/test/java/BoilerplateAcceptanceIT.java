 ...
 */
import com.hpe.caf.worker.boilerplate.BoilerplateTestControllerProvider;
 ...
 */
public class BoilerplateAcceptanceIT extends UseAsTestName_TestBase{
    TestControllerProvider testControllerProvider;
    TestControllerSingle controller;

    @BeforeClass
    public void setUp() throws Exception {
        testControllerProvider = new BoilerplateTestControllerProvider();
