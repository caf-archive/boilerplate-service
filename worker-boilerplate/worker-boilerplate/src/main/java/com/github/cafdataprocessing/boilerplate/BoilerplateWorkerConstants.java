...
public class BoilerplateWorkerConstants {
    ...
    public class FailureConstants{
        public static final String CONFIGURATION_FAILURE = "BOILERPLATE_FAILURE_0001";
        public static final String INVALID_TASK = "BOILERPLATE_FAILURE_0002";
        public static final String TASK_REJECTED_EXCEPTION = "BOILERPLATE_FAILURE_0003";
    }
