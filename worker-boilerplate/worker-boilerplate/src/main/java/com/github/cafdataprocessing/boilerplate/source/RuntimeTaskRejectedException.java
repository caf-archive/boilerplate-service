 ...
 */
package com.github.cafdataprocessing.boilerplate.source;

import com.hpe.caf.api.worker.TaskRejectedException;

/**
 * Created by Jason.Quinn on 21/01/2016.
 */
public class RuntimeTaskRejectedException extends RuntimeException {
    private TaskRejectedException exception;

    public RuntimeTaskRejectedException(TaskRejectedException exception) {
