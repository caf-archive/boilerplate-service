 ...
 */
package com.github.cafdataprocessing.boilerplate.expressionprocessing;
...
import com.github.cafdataprocessing.boilerplate.result.BoilerplateMatch;
...
{
    public ProcessorResult match(final InputStream stream, final List<BoilerplateExpression> expressions,
                                        final RedactionType redactionType, final String defaultReplacementText, final boolean setMatches)
    {
    ...
    private static void writeToOutputStream(RedactionType redactionType, FileBackedOutputStream fileBackedOutputStream, char[] half1)
    {
        if (redactionType != RedactionType.DO_NOTHING) {
            try {
                assert fileBackedOutputStream != null;
